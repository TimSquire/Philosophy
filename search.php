...
$query = "SELECT * FROM articles WHERE title LIKE '%$searched%' or author LIKE '%$searched%' or content LIKE '%$searched%' or date LIKE '%$searched%'";
        ...
        <div class="comments-wrap">
            ...
            <div id="comments" class="row">
                <div class="col-full">
					...
					<div class="respond">
						...
						?>
							<h3 class="h2">Showing Results for<?php echo " '" . $searched . "'"; ?> </h3>
            ...
            <div class="masonry">
				...
				if(mysqli_num_rows($result) <= 0){
					echo '<p4>' . 'No results match your search' . '</p4>';
				} else {
